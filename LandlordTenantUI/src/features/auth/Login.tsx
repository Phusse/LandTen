...
import { AlertCircle, Zap, ShieldOff, Mail } from 'lucide-react'
      ...
      {suspension && (
        ...
        >
          ...
          >
            ...
            {/* Heading */}
            <h2 className="text-center text-xl font-display font-bold text-harbour-text mb-2">
              Account Suspended
            </h2>
            <p className="text-center text-sm text-harbour-text-secondary mb-6 leading-relaxed">
              {suspension.message}
            </p>

            {/* Support CTA */}
            <a
              href="mailto:support@vgc.ng"
              className="flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl bg-harbour-accent text-white font-semibold text-sm hover:opacity-90 transition-opacity"
            >
              <Mail size={16} />
              Contact Support
            </a>
            ...
            <button
              onClick={() => setSuspension(null)}
              className="mt-3 w-full py-2 text-sm text-harbour-text-tertiary hover:text-harbour-text transition-colors"
            >
              Dismiss
            </button>

            {/* Bottom note */}
            <p className="text-center text-xs text-harbour-text-tertiary mt-4 border-t border-harbour-border pt-4">
              If you believe this is a mistake, email us at{' '}
              <span className="font-medium text-harbour-text">support@vgc.ng</span>
            </p>
          </div>
        </div>
      )}
